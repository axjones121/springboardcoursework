...
-- 5. SELECT * FROM analytics WHERE rating >= 4.8 ORDER BY reviews DESCLIMIT 1;
...
-- 10. SELECT * FROM analytics WHERE price BETWEEN 0.1 and 1 ORDER BY reviews DESC LIMIT 10;
